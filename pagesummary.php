					...
					<form method="post">
						<table class="table1">
							...
							<tr class="table-1-row">
								...
								<td><input type="text" style="height:20px; width:180px" name="pagename"></td>
					...
					<form method="post">
						<table class="table2">
							...
							<tbody>
								<?php
								if (isset($_REQUEST['srch'])) {
									$datas = $ob->searchData($_POST);
								} else {
									$datas = $ob->displayData();
								}
								$index = 1;
								...
								?>
									...
									<tr>
										...
										<td><a href="./addpage.php?eid=<?php echo $data['id'] ?>"><img src="./Images/edit.jpg"></a></td>
